...
export const generationPrompts = [
  ...
  "Uma cidade subaquática surreal com peixes nadando entre os prédios",
  "Imagem fotorrealista de um muscle car clássico correndo pelo deserto",
...
export const editingPrompts = [
  ...
  "Aplique um efeito de brilho neon cyberpunk",
  "Remova as pessoas no fundo",
  "Dê uma aparência cinematográfica",
];
